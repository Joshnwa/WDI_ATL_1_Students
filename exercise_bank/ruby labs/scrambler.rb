...
# 	unless alpha_validation(first_name)
# 		print "Enter First Name: "
# 		first_name = gets.chomp
# 		if alpha_validation(first_name) == false
# 			puts "Only alpha characters please"
# 		end
# 	end

# 	unless alpha_validation(last_name)
# 		print "Enter Last Name: "
# 		last_name = gets.chomp
# 		if alpha_validation(last_name) == false
# 			puts "Only alpha characters please"
# 		end
# 	end
